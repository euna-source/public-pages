...
const VERSION = `${PREFIX}1.2.2`;
const SHELL = [
  './', './index.html', './style.css', './app.js', './manifest.webmanifest',
  './lib/collected-time.js', './lib/capture-requests.js', './lib/taste-profile.js', './lib/page-capture.js', './lib/capture-import.js', './lib/ulid.js', './lib/model.js', './lib/db.js', './lib/ui.js',
