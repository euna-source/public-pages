import { refreshCollectionTimes } from './lib/ui.js';
...
setInterval(refreshCollectionTimes, 60000);
document.addEventListener('visibilitychange', () => { if (!document.hidden) refreshCollectionTimes(); });
