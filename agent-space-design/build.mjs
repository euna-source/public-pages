...
await build({entryPoints:[join(root,'sim-src/previs.js')],bundle:true,format:'iife',target:'es2020',minify:true,outfile:join(root,'previs-v2.js')});
...
const previsOutput=join(root,'previs-v2.js');
