...
await build({entryPoints:[join(root,'sim-src/previs.js')],bundle:true,format:'iife',target:'es2020',minify:true,outfile:join(root,'previs-v3.js')});
...
const previsOutput=join(root,'previs-v3.js');
