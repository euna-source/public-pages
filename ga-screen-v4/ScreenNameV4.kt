...
object ScreenGroupV4 {
    val VALUES = listOf("login", "signup", "discovery", "finder", "chatty", "my", "settings")
    val OF: Map<String, String?> = mapOf(
        "app_splash" to "login",
        ...
        "login_password" to "login",
        "login_2fa_email" to "login",
        "reset_password_email" to "login",
        "reset_password_verify" to "login",
        ...
        "profile_cover_edit" to "my",
        "profile_intro_create" to "my",
        "profile_intro_edit" to "my",
        "my_profile_intro" to "signup",
        "discovery_feed" to "discovery",
        "discovery_creator_list" to "discovery",
        "portfolio_detail" to null,
        ...
        "my_info_region" to "my",
        "my_info_region_global_city" to "my",
        "my_info_email_register" to "my",
        ...
        "media_image_edit" to "my",
        "media_video_edit" to "my",
        "portfolio_create" to "my",
        "portfolio_edit" to "my",
        "project_create" to "my",
        "project_edit" to "my",
        "inspiration_create" to "my",
        "inspiration_edit" to "my",
        "chat_room_direct" to "chatty",
        "chat_room_lounge" to "chatty",
        "chat_room_project" to "chatty",
        "chat_room_team" to "chatty",
        "chat_room_menu" to "chatty",
        "lounge_create" to "chatty",
        "lounge_edit" to "chatty",
        "notification_center" to "chatty",
        "contacts_first_connections" to "chatty",
        "contacts_follower" to "chatty",
        "contacts_following" to "chatty",
        "contacts_search_results" to "chatty",
        ...
        "settings_visibility_profile" to "settings",
        "settings_blocked_members" to "settings",
        "settings_change_password" to "settings",
        "settings_2fa" to "settings",
        ...
        "settings_contents_comments" to "settings",
        "settings_contents_respected" to "settings",
        "settings_contents_liked" to "settings",
        "bookmark_creator" to "settings",
        "bookmark_portfolio" to "settings",
        "arcade_card_boss" to "discovery",
        "arcade_breakout" to "discovery",
        "app_update_required" to "login",
        "profile_cover_required" to "my",
        "chat_list" to "chatty",
