...
const CHARACTER_DATA = {
  ...
  "howl": {
    ...
    "note": "8컷 중 놀람의 강도 차이가 포함되어 있어 서로 다른 감정 8종을 뜻하지 않습니다. 공식 2D 인물을 바탕으로 제안한 3D 외관이며, 얼굴의 고유한 인상은 더 다듬을 부분입니다. 같은 모델의 표정 변형은 아직 구현하지 않았습니다.",
  ...
  "soot": {
    ...
    "note": "9개의 정지 행동 시안입니다. 책 읽기·종이 운반·쉬기는 원작의 형태를 이용한 새 생활동작입니다. 일부 몸은 약한 세로 타원입니다. 이 시트의 매끈한 표면과 공간 속 거친 윤곽의 차이를 다음 3D 모델에서 맞춰야 합니다.",
